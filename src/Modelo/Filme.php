...
class Filme
{
    ...
    public function __construct(public readonly string $nomeFilme, public readonly int $anoLancamento, public readonly Genero $generoFilme, public readonly int $duracaoEmMinutos)
    {
